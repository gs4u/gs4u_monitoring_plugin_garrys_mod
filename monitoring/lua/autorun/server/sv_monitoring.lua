...
local APIUrl					= 	"https://api.gs4u.net/" -- API Сайт
local IDServer 					=	""-- ID Сервера
local WeaponsAddons				= 	""	-- M9K, SWBase, FAS и тд
local ServerToken				=	"" --Токен Сервера
local LangIndex_Monitoring 			= 	"ru" 	-- Язык
local MoneysName				=	"₽" 	-- Валюта - Для DarkRP
...
print("[ GS4u Monitoring ] Запуск аддона!")
...
timer.Create("ReloadAddons", 1800, 0, function()
	StartMonitoring()
	print("[ GS4u Monitoring ] Перезапуск аддона прошел успешно!")
end)
print("[ GS4u Monitoring ] Запуск аддона прошел успешно!")
